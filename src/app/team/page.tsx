      ...
      <div className="pt-24 md:pt-28">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <span className="inline-flex items-center gap-2 text-xs font-bold text-[#38804b] uppercase tracking-wider mb-2">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-5">
                <span className="inline-flex items-center gap-2 text-xs font-bold text-[#38804b] uppercase tracking-wider">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-[#38804b]/20 shadow-2xl bg-slate-900 aspect-[4/3]">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white space-y-2">
                  <span className="text-xs uppercase font-bold text-[#38804b] tracking-wider">
