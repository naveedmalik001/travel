      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="relative overflow-hidden bg-gradient-to-br from-[#0B1E15] via-[#112a1f] to-[#081710] text-white p-7 sm:p-8 rounded-3xl shadow-2xl border border-emerald-800/40 space-y-6">
              {/* Subtle ambient light effect */}
              <div className="absolute top-0 right-0 w-48 h-48 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" />
              
              <div className="relative z-10">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-emerald-900/80 text-emerald-300 border border-emerald-700/40 uppercase tracking-wider mb-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                  Curated by Local Team
                </div>
                <h3 className="text-2xl font-extrabold text-white mt-1">{companyInfo.name}</h3>
                <p className="text-xs text-emerald-200/90 font-serif italic mt-0.5">{companyInfo.tagline}</p>
              </div>

              <div className="relative z-10 space-y-4 text-xs sm:text-sm text-slate-200">
                <div className="flex items-start space-x-3.5">
                  <div className="w-9 h-9 rounded-xl bg-emerald-900/90 text-emerald-400 flex items-center justify-center flex-shrink-0 mt-0.5 border border-emerald-700/50 shadow-sm">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center text-xs font-semibold text-emerald-400 hover:text-emerald-300 mt-1.5 transition-colors"
                    >
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1 mt-1">
                      <a href={`tel:${companyInfo.phones[0]}`} className="text-emerald-300 hover:text-white font-semibold text-xs transition-colors">
                        +91 8082495885
                      </a>
                      <span className="text-emerald-700">•</span>
                      <a href={`tel:${companyInfo.phones[1]}`} className="text-emerald-300 hover:text-white font-semibold text-xs transition-colors">
                        +91 7780871705
                      </a>
                    </div>
                  </div>
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-300">6+ Years Field Experience • 24/7 On-Ground Support</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 pt-4 border-t border-emerald-800/60 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2.5">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-900/70 hover:bg-emerald-800 text-emerald-300 transition-colors text-xs font-semibold border border-emerald-700/40"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-1.5 rounded-xl bg-[#38804e] text-white hover:opacity-90 transition-opacity"
                    title="WhatsApp"
                    aria-label="WhatsApp"
                  >
            ...
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 flex items-center justify-between gap-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-xl bg-emerald-50 text-[#38804e] flex items-center justify-center font-bold flex-shrink-0 border border-emerald-100">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-3.5 py-2 bg-[#0B1E15] text-emerald-300 text-xs font-semibold rounded-xl hover:bg-emerald-900 transition-colors flex-shrink-0 min-h-[40px] flex items-center"
              >
                Maps
              </a>
            </div>
          ...
          <div className="lg:col-span-7 bg-slate-50 p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-soft">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 px-6 rounded-xl bg-[#38804e] hover:bg-[#2b693f] text-white font-bold text-sm shadow-md transition-all flex items-center justify-center space-x-2"
                >
