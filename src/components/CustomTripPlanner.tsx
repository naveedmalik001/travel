            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
              ...
              <div className="space-y-1.5 md:col-span-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {[
                    { label: "₹10k - ₹15k (Budget)", value: "₹10,000 - ₹15,000 / person (Budget)" },
                    { label: "₹15k - ₹25k (Popular)", value: "₹15,000 - ₹25,000 / person (Standard / Popular)" },
                    { label: "₹25k - ₹40k (Premium)", value: "₹25,000 - ₹40,000 / person (Premium / 4-Star)" },
                    { label: "₹40k+ (Luxury)", value: "₹40,000+ / person (Luxury Experience)" }
                  ].map((tier) => (
                    <button
                      key={tier.value}
                      type="button"
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-bold text-slate-800 uppercase tracking-wider flex items-center gap-1.5">
                  <User className="w-3.5 h-3.5 text-[#38804e]" />
