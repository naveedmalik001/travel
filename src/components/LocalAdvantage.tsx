      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 relative order-2 lg:order-1">
            <div className="relative h-[320px] sm:h-[420px] lg:h-[480px] rounded-3xl overflow-hidden shadow-2xl">
              <Image
              ...
              <div className="absolute bottom-5 left-5 right-5 p-4 rounded-2xl bg-white/95 backdrop-blur-md shadow-lg border border-slate-100">
                <div className="flex items-center gap-3.5">
                  <div className="w-12 h-12 rounded-xl bg-pine-900 text-amber-300 font-extrabold flex flex-col items-center justify-center flex-shrink-0">
            ...
            {/* Floating badge — meaningful data, not just tagline */}
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-7">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-pine-900 hover:bg-pine-800 text-amber-300 font-bold text-xs sm:text-sm shadow-md transition-all min-h-[44px]"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold text-xs sm:text-sm transition-all min-h-[44px]"
              >
