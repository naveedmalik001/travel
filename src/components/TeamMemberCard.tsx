  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden border border-slate-200/90 shadow-2xs hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col group">
      ...
      <div className="relative h-72 sm:h-80 w-full overflow-hidden bg-slate-900">
        ...
        {/* Category / Role Badge */}
        <div className="absolute top-3 left-3 px-2.5 py-1 rounded-full text-[10px] font-bold bg-[#081f16]/90 text-[#38804b] border border-[#38804b]/40 backdrop-blur-md">
          {member.category}
        </div>
      </div>
      ...
      <div className="p-5 flex-grow flex flex-col justify-between">
        <div>
          {/* Name */}
          <h3 className="text-base sm:text-lg font-extrabold text-slate-900 group-hover:text-[#38804b] transition-colors leading-snug">
            {member.name}
          </h3>

          {/* Role & Specialization */}
          <p className="text-xs font-semibold text-[#38804b] mt-0.5">
            {member.role}
          </p>
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
          <span className="inline-flex items-center gap-1.5 font-bold text-slate-700 bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-200/80">
            <Award className="w-3.5 h-3.5 text-[#38804b]" />
            <span>{member.experience}</span>
          </span>
          <span className="text-[11px] font-semibold text-[#38804b]">
            Local Team
          </span>
        </div>
      </div>
