...
export default function WhatsAppFloat() {
  ...
  if (isDismissed) {
    return (
      <button
        ...
        className="fixed bottom-4 right-4 z-40 p-2.5 rounded-full bg-emerald-800 text-amber-300 shadow-xl hover:bg-emerald-700 transition-all border border-emerald-500/50 text-xs flex items-center gap-2 hover:scale-105"
        title="Open Support & Travel Desk"
      >
        <SupportAgentIcon className="w-5 h-5 text-amber-300 animate-pulse" />
  ...
  return (
    <div className="fixed bottom-4 right-3 sm:bottom-6 sm:right-6 z-40 flex flex-col items-end">
        ...
        <div className="mb-3 w-[305px] sm:w-[340px] bg-white rounded-3xl shadow-2xl border border-slate-200/90 overflow-hidden animate-in slide-in-from-bottom-5 duration-200">
          ...
          <div className="bg-gradient-to-r from-[#0B1E15] via-[#133527] to-[#0B1E15] text-white p-4 flex items-center justify-between border-b border-emerald-900/60">
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="w-10 h-10 rounded-full bg-emerald-700 border-2 border-amber-300 flex items-center justify-center text-white shadow-inner">
                  <SupportAgentIcon className="w-6 h-6 text-amber-300" />
                </div>
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="px-1.5 py-0.5 rounded text-[9px] font-extrabold bg-emerald-500/30 text-emerald-300 uppercase tracking-wide border border-emerald-400/30">
                    ONLINE
                  </span>
                </div>
          ...
          <div className="p-3.5 space-y-2.5 bg-slate-50/50">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <p className="font-bold text-xs text-slate-900 group-hover:text-emerald-800">Fill Trip Planner Form</p>
            ...
            >
              ...
              <span className="text-[10px] text-emerald-700 font-bold bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">Call Now</span>
            </a>
          ...
          <div className="px-3.5 py-2 bg-slate-100 border-t border-slate-200 flex items-center justify-between text-[10px] text-slate-500">
            <span className="flex items-center gap-1 font-medium">
              ...
              Verified Local Tangmarg/Gulmarg Team
            </span>
            <button
      ...
      <div className="flex items-center space-x-2.5">
        {/* Animated Live Status Pill: 'Our Team is Live' (No star/sparkles AI icon) */}
        {showBubble && !isOpen && (
          <div 
            onClick={handleOpenWidget}
            className="cursor-pointer group flex items-center space-x-2 bg-white/95 backdrop-blur-md text-slate-900 px-3.5 py-2 rounded-2xl shadow-xl border border-emerald-300/80 text-xs font-semibold hover:border-emerald-500 transition-all transform hover:scale-[1.02] active:scale-95"
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
          ...
          >
            ...
            <div className="flex flex-col text-left">
              <span className="text-[12px] font-bold text-pine-950 group-hover:text-emerald-700 transition-colors">
                Our Team is Live
              </span>
        ...
        <button
          ...
          className={`w-14 h-14 sm:w-15 sm:h-15 rounded-full shadow-2xl flex items-center justify-center transform hover:scale-105 active:scale-95 transition-all duration-300 relative group ${
            isOpen
              ...
              : "bg-gradient-to-tr from-pine-900 via-emerald-800 to-emerald-700 text-white ring-4 ring-emerald-400/30 hover:ring-emerald-400/60"
          }`}
        ...
        >
          {isOpen ? (
            ...
            <>
              {/* Professional Customer Support Agent with Headset & Boom Mic */}
              <div className="relative flex items-center justify-center">
                <SupportAgentIcon className="w-8 h-8 sm:w-9 sm:h-9 text-amber-300 transition-transform group-hover:scale-110" />
                ...
                <span className="absolute -bottom-1 -right-1 flex h-3.5 w-3.5">
                  ...
                  <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-emerald-500 border-2 border-pine-950" />
                </span>
              </div>
            </>
          )}
